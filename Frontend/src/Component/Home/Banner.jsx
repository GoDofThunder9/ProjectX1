...
const VideoBanner = () => {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {  // Fixed here
  ...
  // Handle autoplay in case browser blocks it
  useEffect(() => {
  ...
  return (
    <div className="video-banner" ref={videoRef}>
      ...
      <div className="connection-logo">
        ...
        <a href="https://wa.me/6267533139?text=Hello%20there%2C%20I'm%20interested%20in%20your%20services!" target="_blank" rel="noopener noreferrer">
